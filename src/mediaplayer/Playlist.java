...
public class Playlist implements Serializable{
        ...
        mediaplayer.setOnReady(new Runnable(){
			...
			public void run() {
		        ...
		        try
		           ...
		           {
		              try {
						image = new Image(Playlist.class.getResource("pusheen.png").toURI().toString());
    ...
    public void refreshtMetadata(ArrayList<Media> list)
    {
    	System.out.println("Playlist NULL 'Playlist.refreshMetadata()': refreshing metadataStarted");
    }
