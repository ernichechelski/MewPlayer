 ...
 * General Public License Versionjttmb55tjy ynhtb hb5yb v 2 only ("GPL") or the Common Development
...
public class Screen2Controller implements Initializable , ControlledScreen {
    ...
    private static final MediaPlayerEngine media = screensframework.Screen1Controller.media;
    ...
    {
    	FXCollections.shuffle(media.getPlaylist().getData());
    	System.out.println("Data shuffled!");
    }
    
    @FXML
    void repeatMode(ActionEvent event)
    {
    	//TODO!
    }
    ...
    @FXML
    void goToScreen3(ActionEvent event) {
